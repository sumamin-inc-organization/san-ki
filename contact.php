...
<body>
    ...
    <nav class="header__nav">
        <a href="index.html" class="header_nav_logo">
        ...
        <div class="header_nav_inner">
            <ul class="header_nav_menu">
                ...
                <li class="header_nav_list hover_opacity">
                    <a href="index.html#service">事業案内</a>
                </li>
                <li class="header_nav_list hover_opacity">
                    <a href="index.html#company">会社概要</a>
                </li>
            ...
            <div class="header_nav_contact_wrap">
                <a href="index.html#contact" class="header_nav_contact">
    ...
    <div id="luxy">
        <main class="main">
            <section id="thanks">
                <div class="thanks_inner" data-anime="initial-fadeIn">
                    <h1 class="thanks_title">Thank You</h1>
                    <p class="thanks_subtitle">お問い合わせを受け付けました。</p>
                    <p class="thanks_text">この度はお問い合わせいただき、誠にありがとうございます。問題なく承りましたら、折り返しのメール（自動返信）をお送りさせていただいております。もし、メールが30分以内に届かない場合は、完了していない可能性がございますので、お手数をお掛けしますが、再度フォームにご記入いただければ幸いです。</p>
                    <p class="thanks_note">※メーラーの設定上、迷惑フォルダに入ってしまう可能性もございますので、合わせて、フォルダの中身もご確認くださいませ。</p>
                </div>
                <a class="thanks_back_btn" href="index.html"><span>TOPに戻る</span></a>
            </section>
        </main>
        <footer class="footer">
            <div class="footer_upper">
                <div class="footer_info_wrap">
                    <a href="index.html#top" class="footer_logo">
                ...
                <div class="footer_menu_wrap">
                    <ul class="footer_menu">
                        <!-- <li class="footer_list">
                            <a href="index.html/#top" class="hover_opacity">TOP</a>
                        </li> -->
                        <li class="footer_list">
                            <a href="index.html#about" class="hover_opacity">私たちについて</a>
                        </li>
                        <li class="footer_list">
                            <a href="index.html#service" class="hover_opacity">事業内容</a>
                        </li>
                        <li class="footer_list">
                            <a href="index.html#company" class="hover_opacity">会社概要</a>
                        </li>
                        <li class="footer_list">
                            <a href="index.html#contact" class="hover_opacity">お問い合わせ</a>
                        </li>
                    </ul>
                    <div class="sns_link">
            ...
            <div class="footer_bottom">
                ...
                <a href="index.html/#top" class="pagetop">
                    <svg width="50" height="51" viewBox="0 0 50 51" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <path class="arrow" d="M25 33.9399L25 17.9399M25 17.9399L30 23.4257M25 17.9399L20 23.4257" stroke="index.html/#4FA149"/>
                    </svg>
                </a>
            </div>
        </footer>
...
//メール設定
    // 管理者に送信するメールの設定
    $to = "s.kumagawa@sumamin.com";
    $subject = "株式会社三喜ホームページよりお問い合わせがありました";
    $messages = "お名前: $name\n電話番号: $tel\nメールアドレス: $email\nお問合せ内容: $message";
    $headers = "From: s.kumagawa@sumamin.com";
    ...
    if (mail($to, $subject, $messages, $headers)) {
        ...
        $auto_reply_message = "$name 様\n\nこの度はお問い合わせいただきありがとうございます。以下の内容でお問い合わせを受け付けました。\n\n" .
                                ...
                                "------------------------------";
        $auto_reply_headers = "From: s.kumagawa@sumamin.com";
